...
var DetectNetwork = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _netinfo.NetInfo.isConnectionExpensive();
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _netinfo.NetInfo.getConnectionInfo();
  ...
  (0, _createClass2.default)(DetectNetwork, [{
    ...
    value: function _addListeners() {
      ...
      _netinfo.NetInfo.addEventListener('connectionChange', function (connectionInfo) {
        _this2._setShouldInitUpdateReach(false);

        _this2._update(connectionInfo.type);
      });

      _netinfo.AppState.addEventListener('change', /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var connectionInfo;
...
var isLegacy = typeof _netinfo.NetInfo.getConnectionInfo === 'undefined';

var _default = function _default(callback) {
  isLegacy ? new _detectNetworkNative.default(callback) : new DetectNetwork(callback);
  return isLegacy;
};
